 ...
 *                  if anything goes wrong.
     */
    public Launcher(String sspHost, int sspPort) throws Exception {
        ...
        context.addServlet(new ServletHolder(createServlet(new TelematikSpeechlet(sspHost, sspPort))), "/telematik");
        server.start();
        server.join();
    }

    /**
     * Main Method for starting this class directly.
     *
     * @param args
     *            ignored.
     * @throws Exception
    ...
    public static void main(final String[] args) throws Exception {
        ...
        new Launcher(args[0], Integer.parseInt(args[1]));
    }
